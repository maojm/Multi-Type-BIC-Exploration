...
\jmedit{We are not guessing types according to their probabilities. The reason is that our goal in each phase is to explore each type for certain number of rounds. Guessing a type according to its probability will make rare types even rarer to appear and be guessed correctly. And this is against us.}

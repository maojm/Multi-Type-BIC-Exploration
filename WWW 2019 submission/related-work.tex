...
%under the name \emph{strategic experimentation}.


\ascomment{Discuss \cite{ICexplorationGames-ec16-working} and \cite{Kempe-colt18}}

\asedit{Recommendation policies with no explicit exploration, and closely related ``greedy algorithm" in multi-armed bandits, have been studied recently \cite{bastani2017exploiting,Sven-aistats18,kannan2018smoothed,externalities-colt18}.

...
Let $S$ be the history of Algorithm \ref{alg:public_main} by the end of phase $\ell-1$. Recall that $S = (S_{l-1} \mid \theta_1,...,\theta_T)$.  Let $S'$ be the history of $\pi$ in the first $\ell-1$ rounds. More precisely, 
    $S' = (R, H_1,...,H_{l-1})$, 
